 ...
 */
var Actualites = /** @class */ (function (_super) {
    __extends(Actualites, _super);
    /**
     * Constructeur
     */
    function Actualites() {
     ...
     */
    Actualites.prototype.getActualite = function () {
        var iActualite = Math.floor(Math.random() * this.length());
        return this.at(iActualite);
    };
    /**
     * Intègre un certain nombre d'actualités dans la collection
     */
    Actualites.prototype.initialiser = function () {
